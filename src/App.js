...
const mapDriver = (r) => ({
  ...
  permisType:       r.permistype || "",
  permisDelivrance: r.permisdelivrance || "",
  permisExpiration: r.license_expiry_date || "",
  pieceNum:         r.id_card_number || "",
  pieceType:        r.piecetype || "CNI",
  pieceDelivrance:  r.piecedelivrance || "",
  ...
  contactUrgenceTel:r.contacturgencetel || "",
  ...
  adresse:          r.adresse || "",
  dettes:           r.dettes || 0,
  detteCommentaire: r.dettecommentaire || "",
...
const App = () => {
  ...
  const buildDriverPayload = (item) => ({
    ...
    emergency_contact:item.contactUrgence||null,
